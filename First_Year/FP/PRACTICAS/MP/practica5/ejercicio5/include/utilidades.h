//Alumno 1: Crespo Arco, Cristina María.
//Alumno 2: Fernández Jiménez, Cristian.
...
/**
@brief Escribe la longitud y los elementos del array en la salida estÃ¡ndar
@param array El array a imprimir
@param util_array NÃºmero de elementos Ãºtiles en el array
...
/**
 * @brief un mÃ©todo de ordenacion que reciba 
...
/**
 * @brief devuelve sobre el mismo vector el resultado sin valores repetidos. (MÉTODO NUEVO)
 * @param array1
 * @param utilArray1
 */
void unico2 (double array1[], int &utilArray1);
