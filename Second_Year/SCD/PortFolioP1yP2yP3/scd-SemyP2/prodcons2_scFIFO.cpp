...
// Seminario 2: Implementación múltiples prodCons SC (opción FIFO)
//
...
constexpr int
   ...
   num_prods = 2,                // numero de productores
   num_cons = 2;                 // número de consumidores
...
//--------------------------------------------------------------------------------
// clase para monitor buffer, version FIFO, semántica SC, múltiples prod. y cons.
//--------------------------------------------------------------------------------
class ProdCons2SC
{
 private:
   ...
   int buffer[num_celdas_total],             //  buffer de tamaño fijo, con los datos
       ...
       primera_ocupada,                      //  indice de la primera celda ocupada (que no ha sido consumida)
...
// funciones de hebras
// -----------------------------------------------------------------------------
void funcion_hebra_productora( ProdCons2SC * monitor, int num_hebra_prod )
{
...
// -----------------------------------------------------------------------------
void funcion_hebra_consumidora( ProdCons2SC * monitor, int num_hebra_con )
{
