...
// Implementación del problema de los filósofos (sin camarero y con interbloqueo).
...
void funcion_filosofos( int id )
{
  ...
  while ( true )
  {
    ...
    MPI_Ssend(&id_filo,1,MPI_INT,id_ten_izq,0,MPI_COMM_WORLD);       // solicitar tenedor izd

    cout <<"Filósofo " <<id <<" solicita ten. der." <<id_ten_der <<endl;
    MPI_Ssend(&id_filo,1,MPI_INT,id_ten_der,0,MPI_COMM_WORLD);       // solicitar tenedor dch

    cout <<"Filósofo " <<id <<" comienza a comer" <<endl ;
    sleep_for( milliseconds( aleatorio<10,100>() ) );

    cout <<"Filósofo " <<id <<" suelta ten. izq. " <<id_ten_izq <<endl;
    MPI_Ssend(&id_filo,1,MPI_INT,id_ten_izq,0,MPI_COMM_WORLD);       // soltar tenedor izd

    cout<< "Filósofo " <<id <<" suelta ten. der. " <<id_ten_der <<endl;
    MPI_Ssend(&id_filo,1,MPI_INT,id_ten_der,0,MPI_COMM_WORLD);       // soltar tenedor dch
